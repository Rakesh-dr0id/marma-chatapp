      ...
      <div style={containerStyle} >
        ...
        <div className="w-full   xl:w-1/2 flex items-center justify-center">
          ...
          <h1 className="text-3xl font-extrabold mb-20 text-black text-center ">
              Create Your Account
               <h1 className="text-base text-gray-800 font-serif font-extralight mb-10 ml-[20%] text-start">
          ...
          <form className="space-y-4 text-start ml-20">
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  ...
                  <input
                    ...
                    name="role"
                    className="mt-1 ml-2  p-2 w-full bg-gray-200  rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
                  />
                </div>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-[200px] ml-[25%]  mt-5 bg-gradient-to-r from-gray-900 to-gray-400/90 text-white p-2 rounded-md hover:bg-gray-800 focus:outline-none focus:bg-black focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300"
                >
                  Create
                </button>
              </div>
